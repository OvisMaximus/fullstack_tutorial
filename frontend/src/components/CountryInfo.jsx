        ...
        return (
            <div>
                {countryNames.map(name => (
                    <div key = {name}>
                        {name} &nbsp; &nbsp; &nbsp;
                        <button onClick={() => setSelectedCountry(name)}>show</button><br/>
                    </div>
                ))}
            </div>
        )
...
const CountryInfo = () => {
    ...
    const updateCandidates = () => {
        ...
        const matchingCountries = countryNames ? countryNames.filter(countryName =>
            countryName.toLowerCase().includes(searchString)) : null
    ...
    return (
        <div>
            ...
            <CandidateList countryNames={candidates} setSelectedCountry={country.setCountryName}/>
